          ...
          <div className="flex flex-col gap-6">
            {serviceAreaLinks.map((item, index) => (
              <Link href={item.href} key={index}>
                <button className="shadow-md py-3 rounded-lg border border-neutral-9 w-full text-sm sm:text-base">
                  {item.text}
                </button>
              </Link>
            ))}
        ...
        <div className="shadow-lg rounded-lg p-6 flex flex-col">
          ...
          <div className="flex flex-col gap-6">
            {pestControlServicesLinks.map((item, index) => (
              <Link href={item.href} key={index}>
                <button className="shadow-md p-3 rounded-lg border border-neutral-9 w-full text-sm sm:text-base">
                  {item.text}
                </button>
              </Link>
            ))}
