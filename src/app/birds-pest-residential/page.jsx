        ...
        <div className="text-base sm:text-lg leading-7 text-justify">
          ...
          <div className="mt-6">
            ...
            <p className="mb-4">
              ...
              multiply at a very rapid rate. It can easily grow from 10 to
              50-200 in a very short time period.
            </p>
            <p className="mb-4">
            ...
            <ul className="list-decimal pl-6 mb-4">
              <li className="mb-2">
                Birds making the roof or garden as their home.
              </li>
              <li className="mb-2">
              ...
              <li className="mb-2">
                ...
                dropping is a very common issue.
              </li>
              <li className="mb-2">
          ...
          <div className="mt-6">
            <p className="font-semibold py-4 sm:py-8">
              Method to Remove Pest Birds
            </p>
            <p className="mb-4">
              The surest way to remove birds is to eliminate the food sources.
              This will discourage them from settling in and near your home.
              Moreover, you can try below-mentioned tactics to remove birds:
            </p>
            <ul className="list-decimal pl-6 mb-4">
              <li className="mb-2">
                Seal all the hole in the roof and outside the house. This will
                prevent nesting of birds.
              </li>
              <li className="mb-2">
                If the birds have already made their nest, prevent their access.
                This can be done by adding some barriers.
              </li>
              <li className="mb-2">
                Avoid leaving leftover food outside the home, these attract the
                birds and encourage them to nest nearby so that they can have
                quick access to food always.
              </li>
              <li className="mb-2">
                Make sure to well cover all outside furniture and discard trash.
              </li>
            </ul>
          </div>
          <div className="mt-6">
          ...
          <div className="mt-6">
            ...
            <p className="mb-4">
              Pest birds can be a serious trouble at your home, among all the
              bird’s Pigeons and Seagulls are the biggest troublemakers. The
              pigeons look for food and grain, they can takeaways the food from
              trash and dirty places. Moreover, they breed the entire year and
              can quickly multiply.
            </p>
            <p className="mb-4">
              The Seagulls have a lifespan of 4 years and during this time
              duration they multiply and create all sorts of trouble at home and
              office. Moreover, once they find a nesting place they return to
              the same place every year. It gets extremely difficult to remove
              and prevent them for future visits.
            </p>
            <p className="mb-4">
              The best practice is to hire a team of experts and experienced
              professionals like Pest-SA Adelaide to get rid of pest birds and
              make your home and office a safe place. They make use of different
              removal techniques to remove the bird, discard nesting and prevent
              similar future incidences.
            </p>
            <p className="mb-4">
              It is mandatory to put a full stop to the growing bird issue. An
              effective bird control program through a trusted pest control
              company can solve your issue. These methods won’t harm the birds
              nor damage your house. Reach out a credible pest control company
              to solve the problem at the earliest and protect your home.
            </p>
          </div>
        </div>
      </div>
