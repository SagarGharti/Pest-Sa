      ...
      <div className="w-full lg:w-[65%] flex flex-col gap-8 mb-8 lg:mb-0">
        <div className="text-base sm:text-lg leading-7 text-justify">
          <div className="w-full">
            ...
            <div className="w-full">
              <img src="/ants-pest.png" alt="Ants Pest Control" className="w-full h-auto" />
            </div>
          </div>
          <div className="mt-6">
          ...
          <div className="mt-6">
            <p className="font-semibold py-4 sm:py-8">Method to Get Rid of Ants</p>
            <p className="mb-4">
          ...
          <div className="mt-6">
            ...
            <ul className="list-decimal pl-6 mb-4">
              ...
              <li className="mb-2">
                Keep the kitchen counter free form food particles and clean
              ...
              <li className="mb-2">
                Also prevent the entry of ants by sealing the access point
                like cracks at the door, near the window frames etc.
              </li>
              <li className="mb-2">
                A regular pest control ensures that the overall ant activity
                is reduced to a great extent.
              </li>
            </ul>
          </div>
          <div className="mt-6">
            <p className="font-semibold py-4 sm:py-8">Why Controlling Ant is Important?</p>
            <p className="mb-4">
